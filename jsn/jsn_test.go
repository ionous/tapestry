...
var com = `{"Story:":[{"Paragraph:":[{"TestStatement testName:test:":["factorial",{"TestOutput:":"6"}]},{"TestRule:hook:":["factorial",{"Act:":[{"Say:":{"Numeral:":{"CallPattern:args:":["factorial",{"Inargs:":[{"Inarg:from:":["num",{"FromNum:":3}]}]}]}}}]}]},{"PatternDecl:name:optvars:":["patterns","factorial",{"PatternVariablesTail:":[{"VariableDecl:name:type:":["a","num",{"primitive_type:":"number"}]}]}]},{"PatternActions:patternReturn:patternRules:":["factorial",{"PatternReturn:":{"VariableDecl:name:type:":["a","num",{"primitive_type:":"number"}]}},{"PatternRules:":[{"PatternRule:hook:":["Always",{"Act:":[{"Let:be:":["num",{"FromNum:":{"Mul:by:":["@num",{"Dec:by:":["@num",1]}]}}]}]}]}]}]},{"PatternActions:patternReturn:patternRules:":["factorial",{"PatternReturn:":{"VariableDecl:name:type:":["a","num",{"primitive_type:":"number"}]}},{"PatternRules:":[{"PatternRule:hook:":[{"Cmp:is:num:":["@num","Equals",0]},{"Act:":[{"Let:be:":["num",{"FromNum:":1}]}]}]}]}]}]}]}`
