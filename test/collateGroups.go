...
var runCollateGroups = list.ListReduce{
	...
	List:         core.AssignFromRecordList(GetVariable("settings")),
...
var collateGroups = testpat.Pattern{
	...
	Rules: []rt.Rule{{
		Execute: core.MakeActivity(
			...
			&list.ListEach{
				List: core.AssignFromRecordList(GetVariable("collation", "groups")),
				As:   W("el"),
					...
					&core.ChooseAction{
						If: &core.CallPattern{
							...
							Arguments: core.MakeArgs(
								core.AssignFromRecord(GetVariable("settings")),
								...
								core.AssignFromRecord(GetVariable("el", "settings")),
							),
						},
						Does: core.MakeActivity(
							&core.SetValue{
							...
							&list.ListPush{
								...
								Value: core.AssignFromText(GetVariable("settings", "name"))},
			...
			&core.ChooseAction{
				...
				Does: core.MakeActivity(
					&core.SetValue{
						...
						Value:  core.AssignFromRecord(GetVariable("settings"))},
					&list.ListPush{
						Target: core.Variable("group", "objects"),
						Value:  core.AssignFromText(GetVariable("settings", "name"))},
					&list.ListPush{
						Target: core.Variable("collation", "groups"),
						Value:  core.AssignFromRecord(GetVariable("group")),
					},
				), // end true
			},
		)},
