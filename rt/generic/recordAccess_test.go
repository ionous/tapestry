...
func TestRecordAccess(t *testing.T) {
	t.Run("numbers", func(t *testing.T) {
		...
		} else if e := beep.SetFieldByName("d", rt.FloatOf(5)); e != nil {
			t.Fatal(e)
		} else if el, e := beep.FieldByName("d"); e != nil {
			t.Fatal(e)
	...
	t.Run("text", func(t *testing.T) {
		...
		if boop, e := q.GetField(meta.Variables, "boop"); e != nil {
			...
			t.Fatal("not default", v)
		} else if e := boop.SetFieldByName("t", rt.StringOf("xyzzy")); e != nil {
			t.Fatal(e)
		} else if el, e := boop.FieldByName("t"); e != nil {
			t.Fatal(e)
	...
	t.Run("aspects", func(t *testing.T) {
		...
		if beep, e := q.GetField(meta.Variables, "beep"); e != nil {
			...
			t.Fatal("not default", v)
		} else if e := beep.SetFieldByName("x", rt.BoolOf(true)); e != nil {
			t.Fatal(e)
		} else if el, e := beep.FieldByName("x"); e != nil {
			t.Fatal(e)
			...
			t.Fatal(e)
		} else if e := beep.SetFieldByName("a", rt.StringOf("w")); e != nil {
			t.Fatal(e)
	...
	t.Run("failures", func(t *testing.T) {
		...
		} else if e := beep.SetFieldByName("a", rt.True); e == nil {
			t.Fatal("aspects should be set with strings")
		} else if e := beep.SetFieldByName("x", rt.Empty); e == nil {
			t.Fatal("traits should be set with bools")
		} else if e := beep.SetFieldByName("x", rt.False); e == nil {
