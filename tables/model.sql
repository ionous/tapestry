 ...
 */
create table mdl_plural( domain int not null, many text, one text, at text, primary key( domain, many ) );
...
/* opposites */
create table mdl_rev( domain int not null, oneWord text, otherWord text, at text );
