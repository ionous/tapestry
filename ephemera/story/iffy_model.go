...
func (*Ana) Choices() (choices map[string]string) {
	return map[string]string{
		"$A": "a", "$AN": "an",
	}
}
...
func (*AreBeing) Choices() (choices map[string]string) {
	return map[string]string{
		"$ARE": "are", "$IS": "is",
	}
}
...
func (*AreEither) Choices() (choices map[string]string) {
	return map[string]string{
...
func (*Bool) Choices() (choices map[string]string) {
	return map[string]string{
...
// DebugLevel requires a user-specified string.
type DebugLevel struct {
	At  reader.Position `if:"internal"`
	Str string
}

func (op *DebugLevel) String() string {
	return op.Str
}

func (*DebugLevel) Choices() (choices map[string]string) {
	return map[string]string{
		"$NOTE": "note", "$TO_DO": "to do", "$WARNING": "warning", "$FIX": "fix",
	}
}

func (*DebugLevel) Compose() composer.Spec {
	return composer.Spec{
		Name:  "debug_level",
		Desc:  `Debug level: Debug level.`,
		Group: "list",
		Strings: []string{
			"note", "to do", "warning", "fix",
		},
	}
}
...
// ListCase requires a user-specified string.
type ListCase struct {
	At  reader.Position `if:"internal"`
	Str string
}

func (op *ListCase) String() string {
	return op.Str
}
...
func (*ListEdge) Choices() (choices map[string]string) {
	return map[string]string{
		"$FALSE": "at_back", "$TRUE": "at_front",
	}
}
...
// ListOrder requires a user-specified string.
type ListOrder struct {
	At  reader.Position `if:"internal"`
	Str string
}

func (op *ListOrder) String() string {
	return op.Str
}

func (*ListOrder) Choices() (choices map[string]string) {
	return map[string]string{
		"$FALSE": "ascending", "$TRUE": "descending",
	}
}

func (*ListOrder) Compose() composer.Spec {
	return composer.Spec{
		Name:  "list_order",
