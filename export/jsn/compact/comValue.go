...
func (d *comValue) commit(v interface{}) {
	if d.out != nil {
...
func (d *comValue) SpecifyValue(kind string, value interface{}) {
...
func (d *comValue) SpecifyEnum(kind string, val jsn.Enumeration) {
	var out string
