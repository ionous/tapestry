...
func (op *MapLocations) Generate(rar *Context) (err error) {
	var links []jessLink
...
func connectPlaceToPlaces(rar *Context, src jessLink, dst []jessLink) (err error) {
	if !src.roomLike {
...
func connectDoorToRooms(rar *Context, door jessLink, places []jessLink) (err error) {
...
func connectRoomToPlaces(rar *Context, room jessLink, places []jessLink) (err error) {
	for i, cnt := 0, len(places); i < cnt && err == nil; i++ {
		if p := places[i]; !p.roomLike {
...
func connectDoorToRoom(rar *Context, door, room jessLink, direction string) (err error) {
...
func connectRoomToDoor(rar *Context, room, door jessLink, direction string) (err error) {
...
func connectRoomToRoom(rar *Context, room, otherRoom jessLink, direction string) (err error) {
...
func reverse(rar *Context, direction string) (string, error) {
...
func createPrivateDoor(rar *Context, direction string, room, otherRoom jessLink) (ret string, err error) {
