...
func Register(reg func(any)) {
	...
	reg(Trait{})
	reg(Traits{})
	reg(AdditionalTraits{})
	reg(Words{})
	reg(Verb{})
	reg(MatchedPhrase{})
	reg(KindsAreKind{})
	reg(KindsAreTraits{})
	reg(AspectsAreTraits{})
	reg(VerbNamesAreNames{})
	reg(NamesVerbNames{})
	reg(NamesAreLikeVerbs{})
	reg(VerbPhrase{})
	reg(Adjectives{})
	reg(AdditionalAdjectives{})
	reg(PropertyNounValue{})
	reg(NounPropertyValue{})
	reg(SingleValue{})
	reg(QuotedText{})
	reg(MatchingNum{})
	reg(KindsHaveProperties{})
	reg(CalledName{})
	reg(PropertyType{})
	reg(KindsAreEither{})
	reg(NewTrait{})
	...
	reg(Understand{})
	reg(MapLocations{})
	reg(AdditionalDirections{})
	reg(MapDirections{})
	reg(MapConnections{})
	reg(DirectionOfLinking{})
	reg(Direction{})
	reg(Linking{})
	reg(AdditionalLinks{})
}
