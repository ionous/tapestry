...
func getNamedValue(run rt.Runtime, name string, path []rt.Dotted) (ret rt.Value, err error) {
...
func getObjValue(run rt.Runtime, name string, path []rt.Dotted) (ret rt.Value, err error) {
