...
// User implements: BoolEval, Literal.
...
func FieldValue_Marshal(m jsn.Marshaler, val *FieldValue) (err error) {
	if err = m.MarshalBlock(FieldValue_Flow{val}); err == nil {
		...
		if e1 == nil {
			e1 = Literal_Marshal(m, &val.Value)
		}
...
var Literal_Optional_Marshal = Literal_Marshal

type Literal_Slot struct{ ptr *Literal }

func (at Literal_Slot) GetType() string              { return Literal_Type }
func (at Literal_Slot) GetSlot() (interface{}, bool) { return *at.ptr, *at.ptr != nil }
func (at Literal_Slot) SetSlot(v interface{}) (okay bool) {
	(*at.ptr), okay = v.(Literal)
	return
}

func Literal_Marshal(m jsn.Marshaler, ptr *Literal) (err error) {
	slot := Literal_Slot{ptr}
...
type Literal_Slice []Literal

func (op *Literal_Slice) GetType() string { return Literal_Type }

func (op *Literal_Slice) Marshal(m jsn.Marshaler) error {
	return Literal_Repeats_Marshal(m, (*[]Literal)(op))
}

func (op *Literal_Slice) GetSize() (ret int) {
	if els := *op; els != nil {
		ret = len(els)
	} else {
		ret = -1
...
func (op *Literal_Slice) SetSize(cnt int) {
	var els []Literal
	if cnt >= 0 {
		els = make(Literal_Slice, cnt)
	}
	(*op) = els
}

func (op *Literal_Slice) MarshalEl(m jsn.Marshaler, i int) error {
	return Literal_Marshal(m, &(*op)[i])
}

func Literal_Repeats_Marshal(m jsn.Marshaler, vals *[]Literal) error {
	return jsn.RepeatBlock(m, (*Literal_Slice)(vals))
}

func Literal_Optional_Repeats_Marshal(m jsn.Marshaler, pv *[]Literal) (err error) {
	if *pv != nil || !m.IsEncoding() {
		err = Literal_Repeats_Marshal(m, pv)
	}
	return
}

// NumValue Specify a particular number.
// User implements: NumberEval, Literal.
...
// User implements: NumListEval, Literal.
...
// User implements: RecordEval, Literal.
...
// User implements: TextEval, Literal.
...
// User implements: TextListEval, Literal.
