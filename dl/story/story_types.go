// Package Story contains modeling commands used to define a game world. These commands include the description of scenes, kinds of objects, specific nouns and their properties, the placement and relation between nouns, and so on.
//
...
func init() {
	...
	Zt_CycleText = typeinfo.Flow{
		...
		Markup: map[string]any{
			"comment": "A text string that, when called multiple times, returns each of its inputs in turn.",
		},
	}
	Zt_ShuffleText = typeinfo.Flow{
		...
		Markup: map[string]any{
			"comment": "A text string that, when called multiple times, returns each of its parts in a randomized order.",
		},
	}
	...
	Zt_AspectField = typeinfo.Flow{
		...
		Terms: []typeinfo.Term{{
			Name: "aspect",
			Markup: map[string]any{
				"comment": []interface{}{"The name of an aspect.", "The field will have this same name."},
			},
			Type: &rtti.Zt_TextEval,
		}},
		Slots: []*typeinfo.Slot{
